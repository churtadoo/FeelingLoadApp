...
public class PlayerTrainingAdapter2 extends ArrayAdapter<PlayerTraining> {
    private Context context;
    private ArrayList<PlayerTraining> playerTrainings;

    public PlayerTrainingAdapter2(Context context, ArrayList<PlayerTraining> playerTrainings){
